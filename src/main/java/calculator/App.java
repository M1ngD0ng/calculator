...
public class App {
    public static void main(String[] args) {
        ...
        String answer;
        ArithmeticCalculator arithmeticCalculator = new ArithmeticCalculator(new AddOperator(), new SubtractOperator(), new MultiplyOperator(), new DivideOperator(), new ModOperator());
